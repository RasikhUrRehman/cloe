...
class FitScoreCalculator:
    ...
    def __init__(
        ...
        """
        self.qualification_weight = qualification_weight or settings.QUALIFICATION_WEIGHT
        ...
        total = self.qualification_weight + self.experience_weight + self.verification_weight
    ...
    def calculate_qualification_score(self, qualification: QualificationState) -> Dict[str, Any]:
        """
    ...
    def calculate_experience_score(self, application: ApplicationState) -> Dict[str, Any]:
        """
    ...
    def calculate_verification_score(self, verification: VerificationState) -> Dict[str, Any]:
        """
    ...
    def calculate_fit_score(
        ...
        qual_result = self.calculate_qualification_score(qualification) if qualification else {'score': 0, 'breakdown': {}}
        exp_result = self.calculate_experience_score(application) if application else {'score': 0, 'breakdown': {}}
        ver_result = self.calculate_verification_score(verification) if verification else {'score': 0, 'breakdown': {}}
